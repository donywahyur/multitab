  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Center(
        child: Column(
          children: [
            const Text('Selamat Datang di Aplikasi Konversi'),
            TextField(
              decoration:
                  const InputDecoration(hintText: 'Silakan input Nama anda'),
              onChanged: (text) {
                var textInput = text;
            ...
            const Spacer(),
            Text(
                'Halo ${_nama}, ${_nilaiInput} $_satuanAsal = ${_nilaiHasil} $_satuanTujuan'),
            const Spacer(
              flex: 2,
            )
          ],
